...
<template>
  <div class="w-screen h-full bg-zinc-900 lg:h-screen xl:pt-4">
    <NuxtLink to="/" class="animate-in fade-in-5 duration-1000">
      <div class="ml-16 pt-16 lg:pt-16 lg:mx-64 flex flex-row text-white hover:text-gray-300 animate-in fade-in-5 duration-1000">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 grid-rows-1 lg:grid-rows-2 lg:gap-y-8 lg:gap-x-16 mx-auto w-7/12 mt-16 animate-in fade-in-5 duration-1000">
      <TelegramBut />
      <BoostyBut />
      <TwitchBut />
      <DiscordBut />
