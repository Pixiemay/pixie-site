...
<template>
  <div class="min-h-screen bg-zinc-900 xl:h-full pb-16">
    <div class="pt-6 xl:pt-12 2xl:pt-32 xl:mx-auto xl:mb-4 lg:mb-16 w-full md:w-1/2 animate-in fade-in-5 duration-1000 flex flex-col items-center">
    ...
    <div class="grid xl:grid-cols-2 xl:grid-rows-1 grid-cols-1 grid-rows-2 gap-y-4 xl:gap-x-16 w-9/12 xl:w-6/12 mb-12 lg:flex-row mx-auto mt-8 xl:mt-12 2xl:mt-16">
      <AboutBut class="animate-in fade-in-5 duration-1000" />
      <SocBut class="animate-in fade-in-5 duration-1000"/>
    </div>
    <div class="mx-auto w-9/12 xl:w-3/12 -mt-6 xl:mt-0">
