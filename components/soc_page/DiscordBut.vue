...
<template>
  <a href="https://discord.gg/8M2HgmNcuz" class="h-48
   xl:h-48 2xl:h-44 bg-zinc-800 hover:bg-zinc-700/60 rounded-3xl px-8 py-6 hover:cursor-pointer hover:scale-105 duration-500 ease-in-out">
